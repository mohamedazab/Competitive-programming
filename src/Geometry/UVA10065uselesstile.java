...
public class UVA10065uselesstile {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		double area2=p2.area();
			Polygon p1=Polygon.convexHull(p);
			double areat=p1.area();
			double ans=area2/areat;
			//double x=(double)Math.round(ans * 100) / (double)100;
			out.printf("Tile #%d\nWasted Space = %.2f",im++,100-100*ans);
			out.print(" %\n\n");
